...
val gh = GitHubSettings(org = "de.jds.edu", proj = "learning-cats", publishOrg = "de.jds.edu", license = apache2)

val mainDev =
  Developer("Joscha Seelig", "@learning-cats", "joscha-seelig@protonmail.com", new java.net.URL("http://github.com/learning-cats"))
...
lazy val Learningcats = project.in(file("."))
...
lazy val docs = project
  ...
  .settings(
    ...
    micrositeSettings(gh, mainDev,  "learning-cats"),
    micrositeDocumentationUrl := "/learning-cats/api/de.jds.edu/index.html",
    micrositeDocumentationLabelDescription := "API Documentation",
    micrositeGithubOwner := "de.jds.edu"
  )
lazy val buildSettings = sharedBuildSettings(gh, libs)

lazy val commonSettings = addCompilerPlugins(libs, "kind-projector") ++ sharedCommonSettings ++ scalacAllSettings ++ Seq(
  organization := "de.jds.edu",
